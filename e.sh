...
tempFile="$fileName$hash"                                     # salva nome do arquivo temporario em $tempFile
cp ${entrada}.asm ./nasm/${tempFile}.asm                      # cria arquivo temporario na pasta nasm
cd nasm &&                                                    # navega ate a pasta nasm/
...
rm nasm/${tempFile}*                                          # deleta arquivo temporario
